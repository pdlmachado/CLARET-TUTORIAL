...
[
    ...
    [
        source 1
        target 2
        label "[c] Cliente deve estar cadastrado. Cliente está logado no ifood"
    ]
    edge
    [
        source 2
    ...
    [
        source 4
        target 5
        label "[s] Cliente adiciona na sacola os itens do menu a serem adquiridos com as quantidades indicadas"
    ]
    edge
    [
        source 5
    ...
    [
        source 6
        target 7
        label "[s] Cliente encerra a compra"
    ]
    edge
    [
        source 7
        target 8
        label "[e] system exibe a página de pagamento da compra"
    ]
    edge
    [
        source 8
        target 9
        label "[s] Cliente escolhe pagamento em dinheiro"
    ]
    edge
    [
        source 9
    ...
    [
        source 11
        target 12
        label "[e] system exibe tela para confirmação da compra"
    ]
    edge
    [
        source 12
    ...
    [
        source 13
        target 14
        label "[e] system encaminha pedido ao restaurante e confirma a compra"
    ]
    edge
    [
        source 14
    ...
    [
        source 17
        target 18
        label "[s] Cliente fornece dados válidos do cartão de crédito"
    ]
    edge
    [
        source 18
        target 19
        label "[e] system confirma o aceite do pagamento com cartão"
    ]
    edge
    [
        source 19
        target 11
        label "[s] Cliente confirma o pagamento com o cartão"
    ]
    edge
    [
        source 12
